...
def human_review_node(state) -> Command[Literal["verify", "sentiment_agent"]]:
    ...
    if review_action == "continue":
        ...
        return Command(goto="sentiment_agent", update={"messages" : [
...
sentiment_agent_node = functools.partial(crew_nodes, agent=sentiment_agent, name = 'sentiment_agent')
...
def create_graph(memory):
    ...
    builder.add_conditional_edges("sentiment_agent", route_after_llm)
