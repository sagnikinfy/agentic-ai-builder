...
def human_review_node(state) -> Command[Literal["verify", "simple_agent"]]:
    ...
    if review_action == "continue":
        ...
        return Command(goto="simple_agent", update={"messages" : [
...
simple_agent_node = functools.partial(crew_nodes, agent=simple_agent, name = 'simple_agent')
...
def create_graph(memory):
    ...
    builder.add_conditional_edges("simple_agent", route_after_llm)
