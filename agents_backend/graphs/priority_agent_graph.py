...
def human_review_node(state) -> Command[Literal["verify_node", "priority_agent_node"]]:
    ...
    if review_action == "continue":
        ...
        return Command(goto="priority_agent_node", update={"messages" : [
...
priority_agent_node = functools.partial(crew_node, agent=priority_agent, name = 'priority_agent')
...
def create_graph(memory):
    ...
    builder.add_edge(START, "priority_agent_node")
    builder.add_conditional_edges("priority_agent_node", route_after_llm)
