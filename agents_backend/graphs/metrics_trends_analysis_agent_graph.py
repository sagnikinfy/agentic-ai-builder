...
from agents.metrics_trends_analysis_agent import metrics_trends_analysis_agent
...
def human_review_node(state) -> Command[Literal["verify_node", "metrics_trends_analysis_agent_node"]]:
    ...
    if review_action == "continue":
        ...
        return Command(goto="metrics_trends_analysis_agent_node", update={"messages" : [
...
metrics_trends_analysis_agent_node = functools.partial(crew_node, agent=metrics_trends_analysis_agent, name = 'metrics_trends_analysis_agent')

def create_graph(memory):
    builder = StateGraph(State)
    builder.add_node("metrics_trends_analysis_agent_node",metrics_trends_analysis_agent_node)
    builder.add_node("verify_node",verify_node)
    builder.add_node("human_review_node",human_review_node)
    builder.add_edge(START, "metrics_trends_analysis_agent_node")
    builder.add_conditional_edges("metrics_trends_analysis_agent_node", route_after_llm)
