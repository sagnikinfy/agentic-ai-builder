...
def human_review_node(state) -> Command[Literal["verify_node", "simple_agent_node"]]:
    ...
    if review_action == "continue":
        ...
        return Command(goto="simple_agent_node", update={"messages" : [
...
simple_agent_node = functools.partial(crew_node, agent=simple_agent, name = 'simple_agent')

def create_graph(memory):
    builder = StateGraph(State)
    builder.add_node("simple_agent_node",simple_agent_node)
    builder.add_node("verify_node",verify_node)
    builder.add_node("human_review_node",human_review_node)
    builder.add_edge(START, "simple_agent_node")
    builder.add_conditional_edges("simple_agent_node", route_after_llm)
