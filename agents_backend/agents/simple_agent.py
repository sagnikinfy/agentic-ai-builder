...
### tool calls
from skills.llm_verification_tool import llm_verification_tool
simple_agent = create_tool_agent(llm=llm, tools = [llm_verification_tool], system_prompt = '''You are a helpful assistant who replies on user's
prompt.
