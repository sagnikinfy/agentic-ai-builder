...
### tool calls
from skills.sentiment_generate import sentiment_generate
sentiment_agent = create_tool_agent(llm=llm, tools = [sentiment_generate], system_prompt = '''
        You are a sentiment generator. Your task is to generate sentiment when user asks about sentiment of a given case.
        Use your tools to complete the request. If you do not have a tool to answer the question, say so. 
        ''')